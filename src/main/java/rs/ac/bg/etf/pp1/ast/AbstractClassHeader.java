...
public class AbstractClassHeader implements SyntaxNode {
    ...
    public AbstractClassHeader (String name, OptClassBaseType OptClassBaseType) {
        this.name=name;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AbstractClassHeader(\n");
